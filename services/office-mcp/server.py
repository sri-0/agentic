...
OUTPUT_DIR = os.environ.get("OFFICE_OUTPUT_DIR", "./out")
...
def render_report_docx(template: str, context: dict[str, Any]) -> str:
    ...
    placeholders). `context` fills the placeholders (supports loops/conditionals).
    Returns a URL to the generated document. Highest fidelity for branded reports.
    """
